...
import 'package:flutter_makefile/src/command_runner.dart';
...
void main() {
  group('FlutterMakefileCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late FlutterMakefileCommandRunner commandRunner;
    ...
    test(
      ...
      () {
        final commandRunner = FlutterMakefileCommandRunner();
    ...
    group('--verbose', () {
      ...
      test('enables verbose logging for sub commands', () async {
        ...
        verify(() => logger.detail('    - force: true')).called(1);
      });
    });
  });
}
